...
#########################################################################################################
# INDIVIDUAL_RECIPE_VARIABLE			-	Add a unique recipe variable.

# name = "NAME IN CRAFTING";			-	Add a name for the recipe.
...
# requiresFire = 0;						-	Does the recipe requires a inflamed object?
											eg. a fire place or furnace?
											1 / 0
											
# requiredInteractionModelGroup = "X";	-	Interaction model to use.
...
# tools[] = {							-	The tools to use for the finished product.
		"CLASSNAME"							Add a classname here eg.
	};										"Exile_Item_Wrench", "Exile_Item_Hammer"

# returnedItems[] = {					-	THE product to return from the recipe.
		{X,	"CLASSNAME"},					{X=AMOUNT, "OF CLASSNAME"} eg.
		{X, "CLASSNAME"}					{1, "Exile_Item_CampFireKit"}
	};										If you had to add fuel or water into the recipe eg.
											"Exile_Item_FuelCanisterFull" or
											"Exile_Item_WaterCanisterDirtyWater" you have to add the 
											empty counterpart to the returned items eg.
											"Exile_Item_FuelCanisterEmpty" or
											"Exile_Item_WaterCanisterEmpty"

# category = "CATEGORY NAME";			-	The individual category name for Brama's Cookbook.
